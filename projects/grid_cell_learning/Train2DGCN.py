...
if __name__ == "__main__":
    ...
    parser.add_argument('--numX',type=float, default=256,)
    parser.add_argument('--numY',type=float, default=64,)
    parser.add_argument('--inhibitionWindow',type=float, default=100,)
    parser.add_argument('--inhibitionRadius',type=float, default=.75,)
    parser.add_argument('--inhibitionStrength',type=float, default=450.,)
    parser.add_argument('--excitationWindow',type=float, default=3,)
    ...
    parser.add_argument('--stdpWindow', type=float, default=2,)
    ...
    parser.add_argument('--numPlaces', type=float, default=1000,)
    ...
    parser.add_argument('--lesions', type=float, default=0)
